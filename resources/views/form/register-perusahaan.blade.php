            ...
            <div class="w-full max-w-4xl bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <form action="{{ route('perusahaan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label class="ml-4 cursor-pointer">
                                        ...
                                        <input type="file" name="logo_perusahaan" class="hidden" accept="image/*"
                                            required>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-gray-700 text-sm font-medium mb-1">Provinsi</label>
                            ...
                            <div>
                                <label class="block text-gray-700 text-sm font-medium mb-1">Kabupaten/Kota</label>
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-gray-700 text-sm font-medium mb-1">Kecamatan</label>
                            ...
                            <div>
                                <label class="block text-gray-700 text-sm font-medium mb-1">Kelurahan/Desa</label>
                        ...
                        <div class="mt-6">
                            <label class="block text-gray-700 text-sm font-medium mb-1">Detail Alamat Perusahaan</label>
