                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full text-left border-collapse">
                            ...
                            <tbody>
                                @foreach ($listBergabung as $listBergabungs )
                                <tr>
                                    <td class="border px-4 py-2">1</td>
                                    <td class="border px-4 py-2"> <a href="/profile/{{ $listBergabungs->user->id }}">{{ $listBergabungs->user->nama_depan }} {{ $listBergabungs->user->nama_belakang }}</a></td>
                                    <td class="border px-4 py-2"> <a href="#">{{ $listBergabungs->lowongan->nama_lowongan }}</a></td>
